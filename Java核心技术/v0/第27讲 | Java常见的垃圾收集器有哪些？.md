...
- 第二，经过一次Minor GC，Eden就会空闲下来，直到**再次达到Minor GC触发条件，这时候，另外一个Survivor区域则会成为to区域**，**Eden区域的存活对象和From区域对象，会被复制到to区域，并且存活的年龄计数会被加1**。
...
<div align="center"> <img src="pics/27-4.png" width="500" style="zoom:100%"/> </div><br> 
