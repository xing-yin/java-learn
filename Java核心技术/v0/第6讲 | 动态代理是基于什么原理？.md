...
- 另一个典型场景就是**绕过API访问控制**。	我们日常开发时**可能被迫要调用内部API去做些事情**，比如，自定义的高性能NIO框架需要显式地释放DirectBuffer，使用反射绕开限制是一种常见办法。
...
<div align="center"> <img src="pics/6-1.png" width="500" style="zoom:120%"/> </div><br>
